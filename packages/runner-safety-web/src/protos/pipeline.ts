...
// @generated from protobuf file "packages/runner-safety-web/src/protos/pipeline.proto" (package "safety_web", syntax proto3)
// tslint:disable
...
export interface Violation {
  ...
  line: bigint;
  /**
   * @generated from protobuf field: int64 column = 5;
   */
  column: bigint;
  /**
   * @generated from protobuf field: int64 end_line = 6;
   */
  endLine: bigint;
  /**
   * @generated from protobuf field: int64 end_column = 7;
   */
  endColumn: bigint;
  /**
...
class Violation$Type extends MessageType<Violation> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* int64 column */ 5:
          ...
          break;
        case /* int64 end_line */ 6:
          message.endLine = reader.int64().toBigInt();
          break;
        case /* int64 end_column */ 7:
          message.endColumn = reader.int64().toBigInt();
          break;
  ...
  internalBinaryWrite(
    ...
    /* int64 line = 4; */
    if (message.line !== 0n) writer.tag(4, WireType.Varint).int64(message.line);
    /* int64 column = 5; */
    if (message.column !== 0n)
      writer.tag(5, WireType.Varint).int64(message.column);
    /* int64 end_line = 6; */
    if (message.endLine !== 0n)
      writer.tag(6, WireType.Varint).int64(message.endLine);
    /* int64 end_column = 7; */
    if (message.endColumn !== 0n)
      writer.tag(7, WireType.Varint).int64(message.endColumn);
